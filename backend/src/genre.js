...
function humanTextureGuide(voiceActive) {
  ...
  lines.push(
    `视角锚：一章只跟一个视角锚（主角）；禁止「可某人看见了。他皱眉」这类镜头跳切；配角内心不写，只写主角能看见的外部动作；章末钩子不靠配角藏东西。`,
    `机制解释：删掉「他第一次感觉/意识到……像一根引线」这类把爽点因果讲出来的句子，只写身体异变和现场物件。`,
    `信息梯度：一段只引入一个新设定；设定跟动作和代价出场，禁止顿号罗列设定词。`,
    `对白潜台词：每句对白带人物当下的利益或恐惧，或改成绕话/打断/半截话；禁止用对白交代背景；羞辱要有具体动机。`,
    `配角要有自己的欲望和阻力，禁止只发任务、派线索、宣布下一场。`,
    `节奏呼吸：长短交替，高潮前短句成簇、高潮后放一个长句；禁止连续 4 句以上长度接近或全是短句。`,
    `动作与道具：动作要有阻碍、代价或后果并影响下一步；道具不当钩子，钩子靠人物选择；删「搓了三下，搓得发烫」这类无后果动作。`,
    `情绪不直陈：禁止「他第一次感觉羞耻」「一股愤怒涌上心头」，用身体反应、停顿、物件和一次难看的选择演出来。`
  );
  if (voiceActive) {
...
function acceptanceGuide(skill, voiceActive, noPayoff) {
  ...
  lines.push(
    `视角与情绪：全章是否只有 1 个视角锚（主角）、配角内心戏 0 处？对白是否每句都带人物当下的利益或恐惧、且不交代背景？情绪是否 0 处直陈（「感觉羞耻」「愤怒涌上心头」），全部用身体反应、停顿、物件和一次难看的选择演出？`,
    `信息与节奏：每段是否最多引入 1 个新设定、且设定跟动作和代价出场、无顿号罗列？是否 0 句把爽点因果讲破、只留身体异变和现场物件？是否无连续 ≥ 4 句长度接近或全短句，高潮前短句成簇、高潮后接 1 个长句？动作是否都有阻碍、代价或后果，道具不当钩子、无无后果动作？`
  );
